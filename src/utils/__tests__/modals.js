...
describe('Modal utils tests', () => {
  it('should open confirm modal', async () => {
    const createConfirmationStub = jest.spyOn(modalUtils, 'confirm').mockReturnValue(Promise.resolve(null));
  ...
  it('should trigger open alert action', async () => {
    jest.clearAllMocks();
    const createResultFailedStub = jest.spyOn(testResultAction, 'createResultFailed');
